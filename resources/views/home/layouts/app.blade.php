...
<head>
  ...
  <title>@yield('title', config('app.name', 'BizLand')) - {{ $siteInfo['name'] ?? 'BizLand' }}</title>
  <meta name="description" content="@yield('meta_description', $siteInfo['description'] ?? '')">
  <meta name="keywords" content="@yield('meta_keywords', 'business, company, service')">
