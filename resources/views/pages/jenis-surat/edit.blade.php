...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold mb-4">
        <span class="text-muted fw-light">Master Data / <a href="{{ route('jenis-surat.index') }}">Jenis Surat</a> /</span> Edit
    </h4>
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Edit Data: {{ $data->nama }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('jenis-surat.update', $data->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control text-uppercase @error('kode') is-invalid @enderror" id="kode" name="kode" value="{{ old('kode', $data->kode) }}" maxlength="20" required>
                                @error('kode')
