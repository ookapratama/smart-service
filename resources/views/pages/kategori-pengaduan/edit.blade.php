...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold mb-4">
        <span class="text-muted fw-light">Master Data / <a href="{{ route('kategori-pengaduan.index') }}">Kategori Pengaduan</a> /</span> Edit
    </h4>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('kategori-pengaduan.update', $data->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
